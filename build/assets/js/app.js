...
},{"./browserUpdateOptions":3,"./controller/index":6,"./controller/preloader":7,"./utils/controller":8,"browser-update":1}],3:[function(require,module,exports){
"use strict";
...
exports.default = function () {
  controller("custom-scroll", function (self) {
    var scroll = self.find(".js-custom-scroll");
...
exports.default = function () {
  controller("header", function (self) {
    var btn = self.find(".js-header-btn"),
        menu = self.find(".js-header-menu"),
        body = self.closest("body");
    ...
    var lang = self.find(".js-lang"),
        langBtn = self.find(".js-lang-btn"),
        langDrop = self.find(".js-lang-drop");
    langBtn.on("click", function () {
      $(this).toggleClass("active");
      langDrop.toggleClass("show");
    });
...
var _customScroll = require("./customScroll");

var _customScroll2 = _interopRequireDefault(_customScroll);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = [_header2.default, _customScroll2.default];

},{"./customScroll":4,"./header":5}],7:[function(require,module,exports){
"use strict";
...
},{"../utils/getScrollbarWidth":9}],8:[function(require,module,exports){
"use strict";
...
},{"../utils/removePreloader":10}],9:[function(require,module,exports){
"use strict";
